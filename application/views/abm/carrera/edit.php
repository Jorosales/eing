<?php echo form_open('carrera/edit/'.$carrera['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="plan_pdf" value="<?php echo ($this->input->post('plan_pdf') ? $this->input->post('plan_pdf') : $carrera['plan_pdf']); ?>" class="form-control" id="plan_pdf" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="imagen" value="<?php echo ($this->input->post('imagen') ? $this->input->post('imagen') : $carrera['imagen']); ?>" class="form-control" id="imagen" />
