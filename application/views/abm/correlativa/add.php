<?php echo form_open('correlativa/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_ciclo_materia" class="form-control">
				...
				{
					$selected = ($ciclo_materia['id'] == $this->input->post('id_ciclo_materia')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_correlativa" class="form-control">
				...
				{
					$selected = ($correlativa['id'] == $this->input->post('id_correlativa')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_correlativa_tipo" class="form-control">
				...
				{
					$selected = ($correlativas_tipo['id'] == $this->input->post('id_correlativa_tipo')) ? ' selected="selected"' : "";
